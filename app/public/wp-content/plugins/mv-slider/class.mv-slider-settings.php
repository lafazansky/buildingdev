    ...
    class MV_Slider_Settings{
        ...
        public function mv_slider_title_callback(){
            ?>
                ...
                id="mv_slider_title"
                value="<?php
                echo isset( self::$options['mv_slider_title']) ?
                esc_attr( self::$options['mv_slider_title']) : '';
                ?>"
                />
            ...
            foreach( $input as $key => $value){
                switch( $key){
                    case 'mv_slider_title':
                        if( empty( $value)){
                            add_settings_error( 'mv_slider_options', 'mv_slider_message', 'The title field cannot be empty!', 'warning');
